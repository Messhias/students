 ...
 * Class Model
 *
 * Main model class responsible for all connections and database operations.
 *
 * @info -> only supports for now MySQL
 */
class Model
{
    /**
    ...
    public function pageRows($offset, $limit, $where = '')
    {
        ...
        if (empty($where)) $sql = "select * from {$this->table} limit $offset, $limit";
        else $sql = "select * from {$this->table}  where $where limit $offset, $limit";
